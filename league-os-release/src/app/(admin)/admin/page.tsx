  ...
  async function loadAll() {
    ...
    try {
      ...
      const [ct, cs, cteam, cm] = await Promise.all([
        dbClient.from("tournaments").select("id", { count: "exact", head: true }),
        dbClient.from("seasons").select("id", { count: "exact", head: true }),
        dbClient.from("teams").select("id", { count: "exact", head: true }),
        dbClient.from("matches").select("id", { count: "exact", head: true }),
      ]);
